Game.Map.BossCavern = function(){
    ...
    this.addEntityAtRandomPosition(Game.EntityRepository.create('gulyabani'), 0);
};
Game.Map.BossCavern.extend(Game.Map);

var $bsc = Game.Map.BossCavern.prototype;

$bsc._fillCircle = function(tiles, centerX, centerY, radius, tile){
    var x = radius;
    var y = 0;
...
$bsc._generateTiles = function(width, height){
